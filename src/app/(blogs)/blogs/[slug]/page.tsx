...
export const generateMetadata = async ({
  params,
}: DynamicPageProps<{ slug: string }>): Promise<Metadata> => {
...
const SinglePost = async ({ params }: DynamicPageProps<{ slug: string }>) => {
  const routeParams = await params;
