...
const RHFSelect = ({
  ...
  useEffect(() => {
    ...
    setDirection(spaceBelow < 200 && spaceAbove > spaceBelow ? "top" : "bottom");
  }, [open]);
    ...
    <div className="relative" ref={ref}>
      ...
      >
        {selectedOption?.label || (
          <span className="text-secondary-400 text-sm py-0.5">{placeholder}</span>
        )}
      ...
      <ul className={`absolute w-full bg-secondary-0 rounded-lg border border-secondary-200 overflow-hidden shadow-lg z-[2] transition-all duration-300 ease-linear overflow-y-auto scrollbar-thin scrollbar-thumb-primary-200 scrollbar-track-transparent scrollbar-thumb-rounded-xl
