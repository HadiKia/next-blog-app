    ...
    <>
      ...
      <header className="z-[2] sticky top-0 bg-secondary-100 border-b border-secondary-200 duration-300 ease-linear">
        <div className="container xl:max-w-screen-xl flex items-center gap-x-2 lg:gap-x-10 text-secondary-400 h-14 lg:h-16 overflow-hidden">
          ...
          <div className="relative fill-primary-700 w-24 lg:w-28">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 394 79">
              ...
              <path fillRule="evenodd" d="M80.907 79.339 17.015 0H0v79.306h13.612V16.952l50.195 62.387z" clipRule="evenodd" />
          ...
          <nav className="hidden lg:flex gap-x-10 h-full">
          ...
          <div className="ms-auto flex items-center lg:gap-x-8 h-full">
            <ThemeSwitcher />
